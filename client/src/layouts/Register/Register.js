        ...
        <>
            {load ? (
                <>
                    ...
                    ></div>
                    <SemipolarLoading color="red" speed="1" size="large" />
                </>
            ) : null}
            <div className="wrapper-login">
                <div className="container-login100">
                    <div
                        ...
                        style={{ paddingTop: "70px", paddingBottom: "15px" }}
                    >
                        <form className="login100-form" onSubmit={onSubmit}>
                            ...
                            <div
                                className="login100-form-footer"
